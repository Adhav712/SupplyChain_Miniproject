...
function Org5Up () {
  ...
  if [ "$CONTAINER_CLI" == "podman" ]; then
    cp ../podman/core.ymal ../../organizations/peerOrganizations/org5.example.com/peers/peer0.org5.example.com/
  fi
...
COMPOSE_FILE_COUCH_ORG3=compose/compose-couch-org3.yaml
# use this as the default docker-compose yaml definition
COMPOSE_FILE_ORG3=compose/compose-org3.yaml
# certificate authorities compose file
COMPOSE_FILE_CA_ORG3=compose/compose-ca-org3.yaml
# database
DATABASE="leveldb"
